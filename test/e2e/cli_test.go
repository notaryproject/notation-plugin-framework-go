...
const pluginPath = "./bin/com.example.plugin"
...
func TestSuccess(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			validateSuccess(name, test.stdin, test.expectedStdout, t)
		})
	}
}
	...
	for _, cmd := range cmds {
		for _, input := range stdInputs {
			t.Run(cmd+"_"+input, func(t *testing.T) {
				validateFailure(cmd, input, expectedValidationErr, t)
			})
		}
	}

	// get-plugin-metadata input has all of its keys as optional
...
func execute(arg, stdInput string, t *testing.T) (string, string, error) {
...
func validateSuccess(arg, stdInput, expectedStdOut string, t *testing.T) {
	stdOut, stdErr, err := execute(arg, stdInput, t)
...
func validateFailure(arg, stdInput, expectedStdError string, t *testing.T) {
	stdOut, stdErr, err := execute(arg, stdInput, t)
